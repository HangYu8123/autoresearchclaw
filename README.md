...
hitl:
  ...
  cost_budget_usd: 1.0               # Pause when cost exceeds budget (0 = no limit)
...
# === LLM ===
llm:
  provider: "deepseek"             # openai | openrouter | deepseek | minimax | volcengine | volcengine-coding-plan | byteplus | byteplus-coding-plan | acp | openai-compatible
  base_url: "https://api.deepseek.com/v1" # API endpoint
  api_key_env: "DEEPSEEK_API_KEY"  # Env var for API key
...
hitl:
  ...
  cost_budget_usd: 1.0              # Cost limit in USD (0 = no limit)
  notifications:
