...
def _get_client() -> arxiv.Client:
    ...
    if _client is None:
        _client = arxiv.Client(
            page_size=ARXIV_MAX_RESULTS_PER_QUERY,
...
def search_arxiv(
    query: str,
    *,
    limit: int = ARXIV_MAX_RESULTS_PER_QUERY,
    ...
    limit:
        Maximum number of results. Capped at 10 to avoid arXiv 429s.
    sort_by:
    ...
    limit = min(limit, ARXIV_MAX_RESULTS_PER_QUERY)
