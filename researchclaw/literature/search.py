...
from researchclaw.literature.semantic_scholar import is_throttled as _s2_is_throttled
...
def search_papers_multi_query(
    ...
    *,
    ...
    for i, q in enumerate(queries):
        if i > 0:
            effective_delay = inter_query_delay
            if _s2_is_throttled():
                effective_delay = min(inter_query_delay * 2, 5.0)
